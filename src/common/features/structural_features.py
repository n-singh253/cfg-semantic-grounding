"""Structural misalignment features (structural + optional similarity)."""
...
STRUCTURAL_COMBINED_FEATURES = STRUCTURAL_ONLY_FEATURES + SIMILARITY_ONLY_FEATURES
...
def compute_structural_feature_row(
    *,
    subtasks: List[str],
    links: List[Dict[str, Any]],
    node_id_to_snippet: Dict[str, str],
